...
const profileSchema = z.object({
  ...
  phoneNumber: z
    .string()
    .regex(/^[1-9][0-9]{9}$/, "Must be 10 digits")
    .optional()
    .or(z.literal("")),
});
...
export default function CustomerProfile() {
    ...
    customerService
      ...
      .then((res) => {
        ...
        if (p.profileImageUrl)
          setSavedImageUrl(p.profileImageUrl + "?t=" + Date.now());
  ...
  const onSaveProfile = async (data) => {
    ...
    try {
      ...
      if (updated.data.profileImageUrl) {
        setSavedImageUrl(updated.data.profileImageUrl + "?t=" + Date.now());
      }
