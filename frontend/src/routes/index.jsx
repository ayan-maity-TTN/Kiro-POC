  ...
  [
    // ── Public ──────────────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { path: "/products", element: wrap(PublicProducts) },
        { path: "/product", element: wrap(PublicProductDetail) },
      ...
      children: [
        {
          ...
          children: [
            ...
            { path: "/customer/orders", element: wrap(CustomerOrders) },
            {
              ...
              element: wrap(CustomerOrderDetail),
            },
          ],
        },
      ],
      ...
      children: [
        {
          ...
          children: [
            ...
            { path: "/seller/products/add", element: wrap(SellerAddProduct) },
            {
              ...
              element: wrap(SellerEditProduct),
            },
            {
              path: "/seller/products/:id/variations",
              element: wrap(SellerVariations),
            },
